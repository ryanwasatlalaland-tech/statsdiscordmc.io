...
function render(payload) {
  ...
  makeChart("memberChart", {
    type:"line",
    data:{datasets:[{label:"Members",data:chartData(history,"members"),borderColor:"#20e88a",backgroundColor:"rgba(32,232,138,.26)",fill:true,tension:.22,spanGaps:false,pointRadius:history.length > 70 ? 0 : 2,pointHoverRadius:5}]},
  ...
  makeChart("onlineTrendChart", {
    type:"line",
    data:{datasets:[{label:"Online",data:chartData(history,"online"),borderColor:"#00dff0",backgroundColor:"rgba(0,223,240,.24)",fill:true,tension:.22,spanGaps:false,pointRadius:history.length > 70 ? 0 : 2,pointHoverRadius:5}]},
