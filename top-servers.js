  ...
  modalHistoryChart = new Chart(canvas,{
      ...
      datasets:[
        {
          ...
          borderColor:dark ? "#63d8ff" : "#2477d4",
          backgroundColor:dark ? "rgba(99,216,255,.10)" : "rgba(36,119,212,.08)",
          fill:true,
          tension:.28,
          pointRadius:0,
          yAxisID:"members"
        },
        {
          ...
          borderColor:dark ? "#8f9cff" : "#596dd5",
    ...
    options:{
      ...
      scales:{
        ...
        members:{position:"left",beginAtZero:false,grid:{color:dark ? "rgba(120,150,185,.12)" : "rgba(30,82,145,.10)"}},
  ...
  customCompareChart = new Chart(canvas,{
    ...
    data:{
      ...
      datasets:[{
        ...
        borderColor:selected.map((_,index)=>index===0 ? "#63d8ff" : "#4e8fff")
      }]
    },
    options:{
      maintainAspectRatio:false,
